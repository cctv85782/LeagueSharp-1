namespace RethoughtLib.Exceptions
{
    ...
    /// <summary>
    ///     Exceptions that gets thrown when a Menu gets generated multiple times
    /// </summary>
    /// <seealso cref="System.Exception" />
    [Serializable]
    internal class MenuAlreadyGeneratedException : Exception
    {
        #region Constructors and Destructors
        ...
        ///     Initializes a new instance of the <see cref="MissingSpellSlotImplementationException" /> class.
        /// </summary>
        public MenuAlreadyGeneratedException()
        {
        }
        ...
        /// </summary>
        /// <param name="message">The message that describes the error.</param>
        public MenuAlreadyGeneratedException(string message)
            : base(message)
        {
        }
        ...
        ///     Visual Basic) if no inner exception is specified.
        /// </param>
        public MenuAlreadyGeneratedException(string message, Exception innerException)
            : base(message, innerException)
        {
        }
        ...
        ///     information about the source or destination.
        /// </param>
        protected MenuAlreadyGeneratedException(SerializationInfo info, StreamingContext context)
            : base(info, context)
        {
        }
    ...
    /// <seealso cref="System.Exception" />
    [Serializable]
    internal class TranslationFailureException : Exception
    {
        #region Constructors and Destructors
        ...
        /// </summary>
        /// <param name="message">The message that describes the error.</param>
        public TranslationFailureException(string message)
            : base(message)
        {
        }
        ...
        ///     Visual Basic) if no inner exception is specified.
        /// </param>
        public TranslationFailureException(string message, Exception innerException)
            : base(message, innerException)
        {
        }
        ...
        ///     information about the source or destination.
        /// </param>
        protected TranslationFailureException(SerializationInfo info, StreamingContext context)
            : base(info, context)
        {
        }
