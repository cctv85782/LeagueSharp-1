namespace RethoughtLib.Algorithm.Djikstra
{
    ...
    internal class Dijkstra<T, TV> where TV : Connection<T>
    {
        #region Fields
        ...
        /// <returns>node PathBaseClass</returns>
        ...
        {
            Console.WriteLine("Searching for: " + start);
            ...
            if (this.Costs.ContainsKey(start) && GlobalVariables.Debug)
            {
            ...
            Console.WriteLine("Start set to 0");
            ...
            while (this.Base.Count > 0)
            {
                ...
                else
                {
                    foreach (var neighbour in this.GetNeighbors(point))
                    {
                        ...
                        Console.WriteLine("Another Node found");
