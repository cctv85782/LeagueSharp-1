namespace AssemblyName.Champion.Menu.MenuSets.OrbwalkingModes.Combo
{
    ...
    using AssemblyName.MediaLib.Menu;
    using AssemblyName.MediaLib.Menu.Interfaces;
    using AssemblyName.MediaLib.Menu.Presets;
            ...
            var pathBased = new List<MenuItem>()
                                {
                                    ...
                                    new MenuItem("PriorityMode", "Priority/Decisison MOde: ").SetValue(
                                        new StringList(new[] { "ChampionName Priority (TargetSelector)", "TODO: Killable" })),
                                };
