...
namespace Rethought_Twitch.TwitchV1.LaneClear
{
    ...
    internal class W : OrbwalkingChild
    {
        ...
        /// </summary>
        /// <param name="twitchW">The Twitch w.</param>
        ...
        private void OrbwalkingOnBeforeAttack(Orbwalking.BeforeAttackEventArgs args)
        {
            ...
            if (MinionManager.GetMinions(1000, MinionTypes.All, MinionTeam.NotAlly).Count > 3) this.twitchW.Spell.Cast();

            if (MinionManager.GetMinions(400, MinionTypes.All, MinionTeam.Neutral).Any(x => x.HealthPercent > 20)) this.twitchW.Spell.Cast();
        }
