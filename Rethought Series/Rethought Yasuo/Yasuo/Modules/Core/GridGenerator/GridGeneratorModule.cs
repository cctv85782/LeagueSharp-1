...
//    /// </summary>
//    public class GridGeneratorModule
//    {
//        #region Fields
...
//            new (ObjectManager.Player.ServerPosition);

//        /// <summary>
//        ///     The grid
//        /// </summary>
//        public
//            Graph<Vector2, Edge<Vector2>> Graph;
...
//                // foreach dash
//                foreach (var x in
//                    this.Graph.Edges.Where(x => x is YasuoDashConnection).ToList())
//                {
...
//                        if (!this.Graph.Edges.Contains(connection))
//                        {
//                            this.Graph.Edges.Add(connection);
//                        }
//                    }
//                }
//            }
...
//                this.Graph = new Graph<Point, ConnectionBase<Point>>(
...
//            var connections = this.Graph?.Edges;
...
//                    var all = backtracedPath.All(x => x.Start != this.Graph.StartNode);
...
//            if (this.Graph?.Edges == null || !this.Graph.Edges.Any() || this.Graph.Nodes == null)
//            {
//                return;
//            }
...
//                        this.Graph.Edges.Where(x => x is YasuoDashConnection))
//                    {
...
//                            this.Graph?.Edges?.Remove(connection);
//                        }
//                    }
//                }
//            }
...
//                for (var i = 0; i < this.Graph.Edges.Count; i++)
//                {
//                    if (previousPoint.Position == this.Graph.Edges[i].End.Position)
//                    {
//                        //Console.WriteLine(@"[BT] Adding result");
//                        result.Add(this.Graph.Edges[i]);
//                        previousPoint = this.Graph.Edges[i].Start;
//                    }

//                    if (1 == this.Graph.Edges.Count - 1)
//                    {
//                        return result;
//                    }
//                }
