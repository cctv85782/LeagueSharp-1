namespace Rethought_Twitch.TwitchV1.DashToMouse
{
    ...
    internal class DashToMouseModule : ChildBase
    {
        ...
        public DashToMouseModule(TwitchQ twitchQ)
        {
        ...
        private void OnUpdate(EventArgs args)
        {
            ...
            var path = this.twitchQ.GetPath(ObjectManager.Player.ServerPosition, Game.CursorPos);
