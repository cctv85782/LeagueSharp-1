namespace Rethought_Twitch.TwitchV1.Interrupter
{
    ...
    internal class SpellInterrupterModule : ChildBase
    {
        ...
        private readonly List<Obj_AI_Hero> currentlyExecuting = new List<Obj_AI_Hero>();
    ...
    internal class SpellInterrupter
    {
        ...
        public SpellInterrupter(Spell spell, Func<Obj_AI_Hero, bool> additionalCondition = null)
        {
            this.Spell = spell;
