namespace Rethought_Yasuo.Yasuo.Modules.Evade
{
    ...
    internal class RiposteModule : ChildBase
    {
        ...
        public RiposteModule(ISpellIndex spellParent)
        {
        ...
        {
            if (sender.IsMe || sender.IsAlly || !this.spellParent[SpellSlot.W].Spell.IsReady()
