namespace Rethought_Yasuo.Yasuo.Modules.Core.SpellParent.Implementations
{
    ...
    internal class YasuoW : SpellChild
    {
        ...
        {
            this.Spell = new Spell(SpellSlot.W, 0);
            this.Spell.SetSkillshot(0, 250 + ObjectManager.Player.Level * 50, 400, true, SkillshotType.SkillshotLine);
        }
