namespace Rethought_Kayle.KayleV1.Combo
{
    ...
    internal class W : OrbwalkingChild
    {
        ...
        /// </summary>
        /// <param name="kayleRW">Irelia W.</param>
        /// <param name="kayleQ">Irelia Q</param>
        public W(KayleW kayleR, KayleQ kayleQ)
        {
            this.kayleR = kayleR;
            this.kayleQ = kayleQ;
        }
        ...
        private void OnProcessSpellCast(Obj_AI_Base sender, GameObjectProcessSpellCastEventArgs args)
        {
            ...
            if (target == null || this.kayleQ.WillReset(target)) return;
