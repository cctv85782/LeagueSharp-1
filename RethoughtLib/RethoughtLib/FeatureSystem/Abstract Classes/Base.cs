namespace RethoughtLib.FeatureSystem.Abstract_Classes
{
    ...
    public abstract class Base
    {
        ...
        ///     Called when [disable].
        /// </summary>
        protected abstract void OnDisable(object sender, FeatureBaseEventArgs featureBaseEventArgs);

        /// <summary>
        ///     Called when [enable]
        /// </summary>
        protected abstract void OnEnable(object sender, FeatureBaseEventArgs featureBaseEventArgs);
