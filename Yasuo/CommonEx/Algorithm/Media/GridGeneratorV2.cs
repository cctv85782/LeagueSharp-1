namespace Yasuo.CommonEx.Algorithm.Media
{
    ...
    public class GridGeneratorV2 : IGridGenerator
    {
        #region Fields
        ...
        ///     The dict
        /// </summary>
        private Dictionary<int, Dictionary<Connection, int>> dictionary;
        ...
        public Grid Generate()
        {
            try
            {
                ...
                var walkingpath = new Dictionary<Connection, int>();
        ...
        public void Reset()
        {
            this.dictionary = new Dictionary<int, Dictionary<Connection, int>>();
        ...
        private void AddOrUpdate(Dictionary<Connection, int> dict, int level)
        {
            if (GlobalVariables.Debug)
            {
            ...
            {
                this.points.Add(keyvaluepair.Key.To, level);
            }

            Dictionary<Connection, int> entry;
        ...
        {         
            ...
            for (int i = this.depth - 1; i-- > 0;)
            {
                ...
                foreach (var keyValuePair in this.dictionary[i])
                {
                    ...
                    if (keyValuePair.Key.To == prevPoint)
                    {
        ...
        private void BuildDashesAroundPoint(Point point)
        {
            ...
            var localDic = new Dictionary<Connection, int>();
            ...
            foreach (var unit in validUnits.ToList())
            {
                ...
                localDic.Add(
                    new Connection(point, new Point(dash.EndPosition)),
                    id);
            }
        ...
        private void BuildWalkingPath(Vector3[] path)
        {
            ...
            if (this.depth < path.Length - 1)
            {
                ...
                localDic.Add(new Connection(point1, point2), this.depth);
            }
        ...
        // TODO
        /// <summary>
        ///     Builds the walking path around some point (unit).
        ///     Used for walking behind a minion in order To dash around it.
        /// </summary>
        /// <param name="point">The point.</param>
