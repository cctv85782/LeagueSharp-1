namespace Yasuo.Common.Provider
{
    ...
    public class SteelTempestLogicProvider
    {
        ...
        public float BuffTime()
        {
            if (this.HasQ3())
            {
                BuffInstance first = Variables.Player.Buffs.FirstOrDefault(x => x.Name.Contains("yasuoq3w"));
                if (first != null)
                {
        ...
        public SebbyLib.Prediction.PredictionOutput GetPrediction(Obj_AI_Base target, bool aoe)
        {
